...
class RectangularRoom(object):
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return sum([tile for sublist in self.tiles for tile in sublist])
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,robot_type):
    ...
    nums_timesteps = [runSimulationOneTrial(num_robots, speed, width, height, min_coverage, robot_type) for i in range(num_trials)]
    mean = sum(nums_timesteps) / num_trials
    return mean

def runSimulationOneTrial(num_robots, speed, width, height, min_coverage, robot_type):
